...
{
    /// <summary>
    /// ratio매개 변수로 받아 Float의 Min에서 Max 사이의 값을 Lerp 값 반환
    /// </summary>
    [System.Serializable]
    ...
    /// <summary>
    /// ratio매개 변수로 받아 Color의 Min에서 Max 사이의 값을 Lerp 값 반환
    /// </summary>
    [System.Serializable]
    public struct MinMaxXColor
    {
        public Color Min;
        public Color Max;
    ...
    /// <summary>
    /// ratio매개 변수로 받아 Vector3의 Min에서 Max 사이의 값을 Lerp 값 반환
    /// </summary>
    [System.Serializable]
